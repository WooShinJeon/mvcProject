            ...
            <nav class="d-inline-flex mt-2 mt-md-0 ms-md-auto">
               ...
               <c:choose>
                  <c:when test="${not empty user}">
                     ...
                     <a class="me-3 py-2 link-body-emphasis text-decoration-none" href="movieList.jsp">영화목록 보기</a>
                     <a class="me-3 py-2 link-body-emphasis text-decoration-none"
         ...
         <div class="row">
            ...
            <div class="col-6 col-md">
               ...
               <ul class="list-unstyled text-small">
                  <li class="nav-item"><a href="<c:url value ='/BoardListAction.do?pageNum=1'/>" class="link-secondary text-decoration-none">고객 센터</a></li>
